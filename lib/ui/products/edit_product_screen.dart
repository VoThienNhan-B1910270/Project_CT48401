//Định nghĩa trang thêm/cập nhật sản phẩm
...
class _EditProductScreenState extends State<EditProductScreen>{
  ...
  bool _isValidImageUrl(String value){
    return (value.startsWith('http') || value.startsWith('http')) && (value.endsWith('.png') 
  ...
  Widget buildProductPreview(){
    return Row(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: buildImageURLFiled(),
        ),
      ],
    );
  }

  TextFormField buildImageURLFiled(){
    return TextFormField(
